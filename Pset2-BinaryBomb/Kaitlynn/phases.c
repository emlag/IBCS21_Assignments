 ...
 */
listNode node6 = {998, 6, NULL};
listNode node5 = {588, 5, &node6};
listNode node4 = {873, 4, &node5};
listNode node3 = {694, 3, &node4};
listNode node2 = {524, 2, &node3};
listNode node1 = {59, 1, &node2};
