...
{
#if defined(PROBLEM)
    if (strings_not_equal(input, "We have to stand with our North Korean allies.") != 0)
	explode_bomb();
#elif defined(SOLUTION)
    printf("We have to stand with our North Korean allies.\n");
#else
    invalid_phase("1c");
#endif
}
 ...
 */
listNode node6 = {139, 6, NULL};
listNode node5 = {760, 5, &node6};
listNode node4 = {987, 4, &node5};
listNode node3 = {391, 3, &node4};
listNode node2 = {362, 2, &node3};
listNode node1 = {284, 1, &node2};
