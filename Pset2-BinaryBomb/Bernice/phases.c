...
{
#if defined(PROBLEM)
    if (strings_not_equal(input, "Wow! Brazil is big.") != 0)
	explode_bomb();
#elif defined(SOLUTION)
    printf("Wow! Brazil is big.\n");
#else
    invalid_phase("1b");
#endif
}
 ...
 * order.
 */
listNode node6 = {530, 6, NULL};
listNode node5 = {513, 5, &node6};
listNode node4 = {120, 4, &node5};
listNode node3 = {541, 3, &node4};
listNode node2 = {597, 2, &node3};
listNode node1 = {609, 1, &node2};
