...
{
#if defined(PROBLEM)
    if (strings_not_equal(input, "All your base are belong to us.") != 0)
	explode_bomb();
 ...
 */
listNode node6 = {285, 6, NULL};
listNode node5 = {450, 5, &node6};
listNode node4 = {74, 4, &node5};
listNode node3 = {928, 3, &node4};
listNode node2 = {609, 2, &node3};
listNode node1 = {590, 1, &node2};
