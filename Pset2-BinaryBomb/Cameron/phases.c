...
void phase_1(char *input)
{
    ...
    printf("I am just a renegade hockey mom.\n");
#else
    invalid_phase("1b");
#endif
}
...
void phase_5(char *input)
{
    ...
    if (strings_not_equal(theWord, "oilers") != 0)
	explode_bomb();
#elif defined(SOLUTION)
    if (!strcmp("oilers", "devils"))
	printf("25l4o7\n");
    else if (!strcmp("oilers", "flyers"))
	printf("9on567\n");
    else if (!strcmp("oilers", "flames"))
	printf("9o1057\n");
    else if (!strcmp("oilers", "bruins"))
	printf("m63487\n");
    else if (!strcmp("oilers", "sabres"))
	printf("71m657\n");
    else if (!strcmp("oilers", "oilers"))
	printf("j4o567\n");
    else {
 ...
 */
listNode node6 = {684, 6, NULL};
listNode node5 = {170, 5, &node6};
listNode node4 = {896, 4, &node5};
listNode node3 = {684, 3, &node4};
listNode node2 = {129, 2, &node3};
listNode node1 = {437, 1, &node2};
