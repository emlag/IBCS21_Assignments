...
{
#if defined(PROBLEM)
    if (strings_not_equal(input, "I was trying to give Tina Fey more material.") != 0)
	explode_bomb();
#elif defined(SOLUTION)
    printf("I was trying to give Tina Fey more material.\n");
#else
    invalid_phase("1b");
#endif
}
 ...
 */
listNode node6 = {960, 6, NULL};
listNode node5 = {658, 5, &node6};
listNode node4 = {909, 4, &node5};
listNode node3 = {891, 3, &node4};
listNode node2 = {818, 2, &node3};
listNode node1 = {485, 1, &node2};
