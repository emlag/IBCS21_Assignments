 ...
 * order.
 */
listNode node6 = {467, 6, NULL};
listNode node5 = {963, 5, &node6};
listNode node4 = {608, 4, &node5};
listNode node3 = {913, 3, &node4};
listNode node2 = {314, 2, &node3};
listNode node1 = {362, 1, &node2};
