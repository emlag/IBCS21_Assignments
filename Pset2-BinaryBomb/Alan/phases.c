 ...
 * order.
 */
listNode node6 = {851, 6, NULL};
listNode node5 = {97, 5, &node6};
listNode node4 = {485, 4, &node5};
listNode node3 = {740, 3, &node4};
listNode node2 = {296, 2, &node3};
listNode node1 = {730, 1, &node2};
