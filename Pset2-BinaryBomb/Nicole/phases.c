 ...
 */
listNode node6 = {763, 6, NULL};
listNode node5 = {597, 5, &node6};
listNode node4 = {521, 4, &node5};
listNode node3 = {189, 3, &node4};
listNode node2 = {879, 2, &node3};
listNode node1 = {798, 1, &node2};
